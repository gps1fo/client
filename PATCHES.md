...
| P-005 | Nom affiché, nom court et schéma d'URL profonde iOS. `gps1fo.client://` est **ajouté** à côté du schéma amont, que le code Dart route encore. Un schéma PROPRE à l'application : partagé avec le gestionnaire, il serait réclamé par les deux (24/09/2026). | `ios/Runner/Info.plist` | Non : Xcode lit ces valeurs dans le projet, il n'y a pas de surcharge par variante comme sur Android. | Non : propre à notre marque. | 2026-09-24 |
